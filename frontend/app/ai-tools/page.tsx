...
const tools: Array<{
...
}> = [
  {
    ...
    icon: "📝",
    description: "Generate short or long-form video scripts",
  },
  {
    id: "rewrite",
    name: "Rewriting Tool",
  ...
  },
  {
    ...
    icon: "💡",
    description: "Expand and develop your content ideas",
  },
  {
    id: "optimize-title",
    name: "Title Optimization",
    icon: "🎯",
    description: "Generate optimized title variations",
  },
  {
    id: "calendar-autofill",
    name: "Calendar Auto-fill",
    icon: "📅",
    description: "Auto-generate content calendar",
  },
  {
    id: "competitor-analysis",
    name: "Competitor Analysis",
    icon: "🔍",
    description: "Analyze competitors in your niche",
  },
  {
    id: "niche-research",
    name: "Niche Research",
    icon: "📊",
    description: "Research and analyze your niche",
  },
  {
    id: "trending-topics",
  ...
  },
  {
    ...
    icon: "👥",
    description: "Build detailed audience personas",
  },
  {
    id: "viral-score",
    name: "Viral Score Predictor",
    icon: "📈",
    description: "Predict viral potential (0-100)",
  },
];
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setScriptForm({ ...scriptForm, topic: e.target.value })
                }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setScriptForm({
                      ...scriptForm,
                      type: e.target.value as "SHORT" | "LONG",
                    })
                  }
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                  required
            ...
            <PlatformSelector
              ...
              onChange={(platform) =>
                setScriptForm({ ...scriptForm, platform })
              }
              showInfo={false}
            />
            <LanguageSelector
              ...
              onChange={(language) =>
                setScriptForm({ ...scriptForm, language })
              }
              showPopular={true}
            />
            <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setRewriteForm({ ...rewriteForm, content: e.target.value })
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                rows={6}
                required
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRewriteForm({ ...rewriteForm, style: e.target.value })
                  }
              ...
              <PlatformSelector
                ...
                onChange={(platform) =>
                  setRewriteForm({ ...rewriteForm, platform })
                }
                showInfo={false}
              />
            </div>
            <LanguageSelector
              ...
              onChange={(language) =>
                setRewriteForm({ ...rewriteForm, language })
              }
              showPopular={true}
            />
            <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setElaborateForm({ ...elaborateForm, idea: e.target.value })
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                rows={4}
                required
            ...
            <div className="grid grid-cols-2 gap-4">
              <PlatformSelector
                ...
                onChange={(platform) =>
                  setElaborateForm({ ...elaborateForm, platform })
                }
                showInfo={false}
              />
              <div>
            ...
            <LanguageSelector
              ...
              onChange={(language) =>
                setElaborateForm({ ...elaborateForm, language })
              }
              showPopular={true}
            />
            <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setOptimizeForm({ ...optimizeForm, title: e.target.value })
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                required
              />
            ...
            <div className="grid grid-cols-2 gap-4">
              <PlatformSelector
                ...
                onChange={(platform) =>
                  setOptimizeForm({ ...optimizeForm, platform })
                }
                showInfo={false}
              />
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setOptimizeForm({
                      ...optimizeForm,
                      variations: parseInt(e.target.value) || 5,
                    })
                  }
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                />
            ...
            <LanguageSelector
              ...
              onChange={(language) =>
                setOptimizeForm({ ...optimizeForm, language })
              }
              showPopular={true}
            />
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <PlatformSelector
                ...
                onChange={(platform) =>
                  setCalendarForm({ ...calendarForm, platform })
                }
                showInfo={false}
              />
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setCalendarForm({ ...calendarForm, niche: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                  required
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setCalendarForm({
                      ...calendarForm,
                      postsPerWeek: parseInt(e.target.value) || 5,
                    })
                  }
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                />
            ...
            <LanguageSelector
              ...
              onChange={(language) =>
                setCalendarForm({ ...calendarForm, language })
              }
              showPopular={true}
            />
            <button
        ...
        return (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <PlatformSelector
              ...
              onChange={(platform) =>
                setCompetitorForm({ ...competitorForm, platform })
              }
              showInfo={false}
            />
            <LanguageSelector
              ...
              onChange={(language) =>
                setCompetitorForm({ ...competitorForm, language })
              }
              showPopular={true}
            />
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNicheForm({ ...nicheForm, niche: e.target.value })
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                required
              />
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setTrendingForm({ ...trendingForm, niche: e.target.value })
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                required
              />
            ...
            <div className="grid grid-cols-2 gap-4">
              <PlatformSelector
                ...
                onChange={(platform) =>
                  setTrendingForm({ ...trendingForm, platform })
                }
                showInfo={false}
              />
              <div>
            ...
            <LanguageSelector
              ...
              onChange={(language) =>
                setTrendingForm({ ...trendingForm, language })
              }
              showPopular={true}
            />
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setPersonaForm({ ...personaForm, niche: e.target.value })
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                required
              />
            ...
            <PlatformSelector
              ...
              onChange={(platform) =>
                setPersonaForm({ ...personaForm, platform })
              }
              showInfo={false}
            />
            <LanguageSelector
              ...
              onChange={(language) =>
                setPersonaForm({ ...personaForm, language })
              }
              showPopular={true}
            />
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setViralForm({ ...viralForm, title: e.target.value })
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                required
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setViralForm({ ...viralForm, description: e.target.value })
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                rows={2}
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setViralForm({ ...viralForm, hook: e.target.value })
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                rows={2}
              />
            ...
            <div className="grid grid-cols-2 gap-4">
              <PlatformSelector
                ...
                onChange={(platform) =>
                  setViralForm({ ...viralForm, platform })
                }
                showInfo={false}
              />
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setViralForm({ ...viralForm, niche: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <div className="text-lg font-semibold">
                    {result.breakdown.titleScore}/100
                  </div>
                </div>
                <div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <div className="text-lg font-semibold">
                    {result.breakdown.hookScore}/100
                  </div>
                </div>
                <div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <div className="text-lg font-semibold">
                    {result.breakdown.contentScore}/100
                  </div>
                </div>
                <div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <div className="text-lg font-semibold">
                    {result.breakdown.hashtagScore}/100
                  </div>
                </div>
              </div>
