...
export default function ReferralsPage() {
  ...
  const loadData = async () => {
    try {
      ...
      const [codeData, linkData, statsData, leaderboardData] =
        await Promise.all([
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Alert>
                    <AlertCircle className="h-4 w-4" />
                    <AlertDescription>
                      <strong>How it works:</strong> Share your referral link
                      with friends. When they sign up, you both earn credits!
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
