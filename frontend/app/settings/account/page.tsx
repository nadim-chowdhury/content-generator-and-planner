            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  includes your profile, ideas, tasks, analytics, and all other
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  personal data (GDPR Article 17). By default, we anonymize your
                  data to comply with legal requirements. You can choose
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded p-3 mb-4">
                  <p className="text-sm text-blue-800 dark:text-blue-200">
                    <strong>Note:</strong> We recommend exporting your data
                    before deletion. Account deletion is irreversible.
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded p-3">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      <strong>GDPR Notice:</strong> By default, your data will
                      be anonymized (soft delete) to comply with legal and
                      business requirements. Personal identifiers will be
                      removed, but some anonymized data may be retained for
                  ...
                  <div>
                    <label className="flex items-center space-x-2 cursor-pointer">
                      ...
                      <span className="text-sm text-gray-700 dark:text-gray-300">
                        <strong>Permanent deletion</strong> - Remove all data
                        completely (may violate data retention laws)
                      </span>
                    </label>
                  </div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    {hardDelete ? "permanently delete" : "anonymize"} your
