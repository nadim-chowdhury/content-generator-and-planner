    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 mb-4">
          ...
          cookies to report usage statistics and deliver advertisements:
        </p>
        <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
          <li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
          ...
          <li>
            Cookie preferences: Manage cookie preferences in your account
            settings
          </li>
          <li>
            Opt-out tools: Use browser extensions or opt-out tools for specific
            services
          </li>
        </ul>
        <p className="text-gray-700 mb-4">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 mb-4">
          ...
          in technology or legal requirements. We will notify you of any
          material changes.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 mb-4">
          ...
          at privacy@contentgenerator.com
        </p>
      </section>
    </div>
  );
