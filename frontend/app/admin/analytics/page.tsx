...
export default function AdminAnalyticsPage() {
  ...
  >([]);
  const [mauTrend, setMauTrend] = useState<
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <div className="h-64 flex items-end gap-1">
                  {summary.dailySignups.map((day, idx) => {
                    const maxCount = Math.max(
                      ...summary.dailySignups.map((d) => d.count),
                      1
                    );
                ...
                <div className="mt-4 text-sm text-gray-600 dark:text-gray-400">
                  Total:{" "}
                  {summary.dailySignups.reduce((sum, d) => sum + d.count, 0)}{" "}
                  signups
                </div>
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-900 dark:text-white mt-2">
                        ...
                        <div>
                          Agency: {formatCurrency(ltv.byPlan?.AGENCY || 0)}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="space-y-2">
                        {socialMetrics.sharesByPlatform?.map(
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <div className="space-y-3">
                  {summary.topNiches.map((niche, idx) => {
                    const maxCount = Math.max(
                      ...summary.topNiches.map((n) => n.count),
                      1
                    );
