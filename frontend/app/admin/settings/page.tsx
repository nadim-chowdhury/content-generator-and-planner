...
export default function PlatformSettingsPage() {
  ...
  const handleUpdateQuota = async (
    ...
    field: "dailyGenerations" | "monthlyGenerations",
    value: number
  ) => {
    try {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="mb-6 border-b border-gray-200 dark:border-gray-700">
              <nav className="-mb-px flex space-x-8">
                {(["tokens", "quotas", "stripe", "api-keys"] as const).map(
                  (tab) => (
                    <button
                      key={tab}
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                          of {settings.monthlyLimit?.toLocaleString() || 0}{" "}
                          tokens
                        </p>
                        <div className="mt-2 w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                          <div
                            ...
                            style={{
                              width: `${Math.min(
                                settings.monthlyUsagePercentage || 0,
                                100
                              )}%`,
                            }}
                          ></div>
                            ...
                            <div>
                              ...
                              <div className="flex gap-2">
                                <input
                                  type="number"
                                  value={
                                    settings[plan]?.dailyGenerations === -1
                                      ? ""
                                      : settings[plan]?.dailyGenerations || 0
                                  }
                                  onChange={(e) => {
                                    const value =
                                      e.target.value === ""
                                ...
                                <button
                                  onClick={() =>
                                    handleUpdateQuota(
                                      plan,
                                      "dailyGenerations",
                                      quotaSettings[plan]?.dailyGenerations || 0
                                    )
                                  }
                            ...
                            <div>
                              ...
                              <div className="flex gap-2">
                                <input
                                  type="number"
                                  value={
                                    settings[plan]?.monthlyGenerations === -1
                                      ? ""
                                      : settings[plan]?.monthlyGenerations || 0
                                  }
                                  onChange={(e) => {
                                    const value =
                                      e.target.value === ""
                                ...
                                <button
                                  onClick={() =>
                                    handleUpdateQuota(
                                      plan,
                                      "monthlyGenerations",
                                      quotaSettings[plan]?.monthlyGenerations ||
                                        0
                                    )
                                  }
                                  className="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700"
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setStripeSettings({
                              ...stripeSettings,
                              proMonthlyPriceId: e.target.value,
                            })
                          }
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setStripeSettings({
                              ...stripeSettings,
                              proYearlyPriceId: e.target.value,
                            })
                          }
                          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md dark:bg-gray-700 dark:text-white"
                        />
                      ...
                      <button
                        onClick={async () => {
                          try {
                            await adminApi.updateStripeProductIds(
                              stripeSettings
                            );
                            alert(
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      {settings.hasOtherKeys && (
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          Other API keys are configured (Google, Facebook,
                          GitHub, etc.)
                        </p>
                      )}
                    </div>
