...
export default function FolderManager({ onFolderSelect, selectedFolderId, onFolderCreated }: FolderManagerProps) {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm('Are you sure you want to delete this folder? Ideas will be moved to root.')) return;
    try {
  ...
  if (loading) {
    return <div className="text-sm text-gray-500 dark:text-gray-400">Loading folders...</div>;
  }
      ...
      {(showCreateModal || editingFolder) && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 max-w-md w-full mx-4">
            ...
            <form onSubmit={editingFolder ? handleUpdate : handleCreate} className="space-y-4">
              <div>
